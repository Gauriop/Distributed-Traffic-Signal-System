...
# PRIMARY SERVER - READY FOR LOAD BALANCING
...
if __name__ == "__main__":
    print("=" * 80)
    print("🟦 PRIMARY SERVER - FOUR-WAY INTERSECTION VIP PRIORITY SYSTEM")
    print("📡 RUNNING ON PORT 8000 (PRIMARY FOR LOAD BALANCING)")
    print("⚖️ WORKS WITH LOAD BALANCER ON PORT 9000")
    ...
    print("📊 PRIMARY - Waiting for client connections to register their times...")
    print("📊 PRIMARY - Berkeley synchronization will start once all clients connect.")
    ...
    print("🎲 PRIMARY - VIP generation: Manual control via tm.py")
    ...
    print("👑 PRIMARY VIP-Priority Four-Way Signal Server running on port 8000...")
    ...
    try:
        ...
        print(f"   PRIMARY - Final signal status: {stats['signal_status']}")