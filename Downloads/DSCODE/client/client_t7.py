...
def t_signal():
    ...
    try:
        ...
        print(f"   👑 VIP requests handled separately by manual_t6.py")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 80)
    print("🚦 FOUR-WAY INTERSECTION - REGULAR SIGNAL CONTROLLER")
    ...
    print("👑 VIP vehicles: Handled by manual_t6.py")
